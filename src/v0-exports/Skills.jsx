...
const categories = [
  {
    ...
    icon: <Icons.Code2 className="h-7 w-7" />,
  ...
  },
  {
    ...
    icon: <Icons.Palette className="h-7 w-7" />,
  ...
  },
  {
    ...
    icon: <Icons.Server className="h-7 w-7" />,
  ...
  },
  {
    ...
    icon: <Icons.Cloud className="h-7 w-7" />,
